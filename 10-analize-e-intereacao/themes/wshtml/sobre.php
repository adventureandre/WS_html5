...
<div class="container bg-orange">
    <div class="content content-page">
        ...
        <form name="sendcontent" action="<?= HOME; ?>/sucesso" method="post">
            ...
            <a href="<?= HOME; ?>/sucesso" class="btn btn-green radius box box-medium last al-center">Quero Fazer Esse Curos!</a>
        </form>
        <div class="clear"></div>
    </div>
</div>
