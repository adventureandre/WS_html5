...
<header class="container bg-gray">
    <div class="content">
        ...
        <ul class="main_nav fl-right">
            ...
            <li>
                <a class="btn btn-green radius boxshadow" title="Comprar Curso" target="_blank" href="http://www.upinside.com.br/curso/curso-html5">Comprar
                    Curso</a></li>
        </ul>
        <div class="clear"></div>
    </div>
    ...
    <div class="content">
        <header>
            <hgroup class="sectiontitle">
                ...
                <h2>Veja o que o tutor do curso
                    <mark>Robson V. leite</mark>
                    tem a dizer!
                </h2>
            </hgroup>
        </header>

        <video class="video video-large main_video" src="midias/apresentacao.mp4" controls width="400"></video>

        <aside class="al-center">
            <h1>Pronto para
                <a class="btn btn-yelow radius" title="Comprar Curso WS HTML5 Agora!" target="_blank" href="http://www.upinside.com.br/curso/curso-html5">Comprar
                    o WS HTML5</a> e Aprender de Verdade?</h1>
        </aside>
        ...
        <section class="content main_videos" style="padding-bottom: 10px;">
            ...
            <article class="box box-small">
                <div class="thumb">
                    ...
                    <img title="Video Aula Entenda o HTML5" alt="Entenda o HTLM5" src="img/entendendo-o-html5.jpg"/>
                </div>
    ...
    <div class="container bg-body">
        <div class="content " style="padding-bottom: 10px;">
            <article class="main_tec_item box box-small al-center radius">
                <img src="img/tec_semantic.png" alt="HTML5 Semântico" title="Modulo de HTML5 Semântico">
            ...
            <article class="main_tec_item box box-small al-center radius">
                <img src="img/tec_drycss.png" alt="CSS produtivo com OOCSS" title="Modulo de CSS produtivo com OOCSS">
            ...
            <article class="main_tec_item box box-small al-center radius">
                <img src="img/tec_forms.png" alt="Formulários com HTML5" title="Modulo de Formulários com HTML5">
            ...
            <article class="main_tec_item box box-small al-center radius last">
                <img src="img/tec_midia.png" alt="Audio e Videos na Web" title="Modulo de Audio e Videos na Web">
            ...
            <article class="main_tec_item box box-small al-center radius">
                <img src="img/tec_geo.png" alt="Geolocation e HTML5 Storage" title="Modulo de Geolocation e HTML5 Storage">
            ...
            <article class="main_tec_item box box-small al-center radius">
                <img src="img/tec_microdados.png" alt="Distribuição com Micro Dados" title="Modulo de Distribuição com Micro Dados">
    ...
    <div class="content content-page al-center">
        <header>
            <hgroup class="sectiontitle">
                ...
                <h2>Começe Agora Mesmo. O Curso é
        ...
        <a class="btn btn-green btn-big radius " title="Quero Me Matricular no Curso WS HTML5 Agora!" target="_blank" href="http://www.upinside.com.br/curso/curso-html5">Comprar
            WS HTML5!</a>
...
<footer class="container bg-light">
    <section class="main_footer content">
        ...
        <nav class="box box-medium">
            ...
            <ul>
                <li>
                    <a class="shoticon shoticon-section" title="Assita o vídeo de apresentação com Robson V. Leite" href="#apresentacao">Assista
                        o Vídeo</a></li>
                <li>
                    <a class="shoticon shoticon-section" title="Veja as tecnologias que você vai aprender!" href="#tecnologias">Você
                        vai Aprender</a></li>
                <li>
                    <a class="shoticon shoticon-section" title="Mais informações na ficha técnica do curso!" href="#fichatecnica">Ficha
                        Técnica</a></li>
            </ul>
        </nav>
        ...
        <article class="box box-medium">
            ...
            <ul>
                <li>
                    <a class="shoticon shoticon-facebook" target="_blank" rel="nofollow" title="UpInside Treinamentos no Facebook" href="http://www.facebook.com/upinside">Facebook</a>
                </li>
                <li>
                    <a class="shoticon shoticon-google" target="_blank" rel="nofollow" title="UpInside Treinamentos no Google Plus" href="http://plus.google.com/+upinside">Google+</a>
                </li>
                <li>
                    <a class="shoticon shoticon-twitter" target="_blank" rel="nofollow" title="UpInside Treinamentos no Twitter" href="http://www.twitter.com/UpInsideBr">Twitter</a>
                </li>
            </ul>
        </article>
        ...
        <article class="main_ead box box-medium last">
            ...
            <p class="shoticon shoticon-config"><b>Plataforma EAD:</b>
                <a title="Plataforma EAD da UpInside" href="http://www.upisnide.com.br">www.upinside.com.br</a></p>
            <p class="shoticon shoticon-mail"><b>E-mail:</b>
                <a title="Envie um e-mail" href="mailto:cursos@upinside.com.br">cursos@upinside.com.br</a></p>
            <hr>
