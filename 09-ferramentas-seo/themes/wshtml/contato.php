    ...
    <article class="container bg-light">
        <div class="content" style="background: url(<?= INCLUDE_PATH; ?>/img/mapa.png) center center no-repeat">
            ...
            <aside class="fl-right contact_info box-forthreesmall">
                <h1 class="form-legend"><span class="shoticon shoticon-mail shoticon-legendtitle">Formas de Contato:</span></h1>
                <ul>
                    ...
                    <li><b>Pro Facebook: </b> <a title="UpInside no Facebook" href="http://facebook.com/upinside">fb.com/upinside</a></li>
                </ul>
