<article class="container">
    <div class="content" style="padding-bottom: 10px;">
        ...
        <div class="trigger trigger-infor al-center font-light" style="line-height: 1.5;">Está página está inteiramente
            servida com Micro Formatos. Isso é lindo! Isso é Otimização
            Pura!<span style="display: block; font-weight: 500">Você não entendeu? <a style="font-size: 0.8em; padding: 5px 10px;" class="btn btn-blue radius" href="https://www.google.com/webmasters/tools/richsnippets?q=https%3A%2F%2Fwww.upinside.com.br%2Fprojetos%2Fwshtml5%2Fsobre" title="Veja essa página no Google Rich Snippets!" rel="nofollow" target="_blank">Clique aqui</a>, e veja como o Google encherga essa página!</span>
        </div>
        <div class="clear"></div>
    </div>
</article>
    ...
    <div class="content">
        ...
        <article class="m-bottom">
            <div class="box-large">
                ...
                <p itemprop="description">Fundada em 2010, a UPINSIDE se destaca por ter os melhores e mais completos
                    cursos de desenvolvimento. Cursos profissionais, 100% em vídeo aulas, com suporte e
                    certificação!</p>
                <p>Mas não ficamos por ai, além disso a UpInside conta com a mais avançada e intuitiva plataforma do
                    mercado, com um ambiente responsivo onde o aluno conta com um suporte diferencial. Podendo acessar
                    seus cursos quando e onde quiser.</p>
            </div>
        </article>
        ...
        <article class="box box-medium">
            ...
            <ul>
                ...
                <li><b>Site Oficial:</b>
                    <a itemprop="sameAs" href="https://www.upinside.com.br" title="UpInside Treinamentos">upinside.com.br</a>
                </li>
            </ul>

            <p class="address" itemprop="address" itemscope itemtype="https://schema.org/PostalAddress">
                <span itemprop="streetAddress">Rua Lourival da Cruz 174</span>,<br>
                <span itemprop="postalCode">99300000</span> / <span itemprop="addressLocality">Soledade</span>,
                <span itemprop="addressRegion">RS</span><br>
        ...
        <aside>
            ...
            <ul>
                <li>
                    <a itemprop="url" class="shorticon shorticon-google" title="UpInside no Google+" href="https://plus.google.com/+upinside" target="_blank" rel="nofollow">Acompanhe
                        no Google+</a></li>
                <li>
                    <a itemprop="url" class="shorticon shorticon-facebook" title="UpInside no Facebook" href="https://www.facebook.com/upinside" target="_blank" rel="nofollow">Curta
                        no Facebook</a></li>
                <li>
                    <a itemprop="url" class="shorticon shorticon-twitter" title="UpInside no Twitter" href="https://twitter.com/UpInsideBr" target="_blank" rel="nofollow">Siga
                        no Twitter</a></li>
            </ul>
        </aside>
    ...
    <div class="content">
        ...
        <div class="fl-right" style="width: 80%;">
            <header class="articletitle">
                ...
                <p class="tagline">Apaixonado pelo mundo web. Webmaster, trabalha com desenvolvimento, SEO e divulgação
                    desde 2006!</p>
            </header>

            <div>
                <p>Robson V. Leite fundou sua primeira agência web em 2006, Sempre em busca de conhecimento e
                    aprimoramento em 2010 fundou o Blog UpInside, que mais tarde veio a se tornar um portal de vídeo
                    aulas.</p>
                <p>Em 2011 iniciou a <span itemprop="affiliation">UpInside Treinamentos</span>, e como
                    <span itemid="jobTitle">CEO e Professor</span> vem criando os melhores e mais completos cursos em
                    seus segmentos segundo seus alunos.</p>
                <p><span itemprop="description">Eterno aluno, apaixonado por PHP, artista da web.</span> Esse será seu
                    tutor neste curso.</p>
                <ul class="main_bus_person">
                    <li>
                        <a itemprop="url" class="boxshadow" target="_blank" href="https://www.facebook.com/robson.v.leite" title="Robson V. Leite No Facebook!">No
                            Facebook</a></li>
                    <li>
                        <a itemprop="url" class="boxshadow g" target="_blank" href="https://plus.google.com/+RobsonVLeite/posts" title="Robson V. Leite No Google+!">No
                            Google+</a></li>
                    <li>
                        <a itemprop="email" class="boxshadow m" href="mailto:Robson V. Leite <cursos@upinside.com.br>" title="Enviar E-mail Para Robson V. Leite">Por
                            E-mail</a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="bg-bluelight">
        <div class="content content-page" style="padding-bottom: 20px;">
            ...
            <div style="margin-bottom: 4%">
                ...
                <p itemprop="description">HTML5 do Jeito Certo trata de um conjunto de técnicas profissionais
                    desenvolvidas e testadas pela UpInside. Fragmentando o desenvolvimento em 3 pilares para entregar um
                    site extremamente otimizado...</p>
                <p class="fontsize1b" style="color: #CF4823" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating">
                    &starf; &starf; &starf; &starf; &starf;
                    Media de <span itemprop="ratingValue">5</span> Estrelas Para <span itemprop="reviewCount">6</span>
                    Avaliações!
                </p>
            </div>
            ...
            for ($i = 1; $i <= 6; $i++):
                ...
                <article itemprop="review" itemscope itemtype="https://schema.org/Review" class="depoiment box box-large bg-light<?= $last; ?>" style="padding: 20px; width: 48%; margin: 0 4% 4% 0">
                    <header class="articletitle" style="margin-bottom: 15px; padding-bottom: 15px; border-bottom: 1px solid #999;">
                        ...
                        <div class="fl-right" style="width: 80%;">
                            <h1 style="font-size: 1.4em;">Depoimento de <span itemprop="author">Robson V. Leite</span>:
                            </h1>
                            <p style="margin: 5px 0;">Em
                                <time itemprop="datePublished" datetime="2014-09-13">9 de setembro de 2014</time>
                            </p>
                    ...
                    <p itemprop="reviewBody">O curso é perfeito em todos os sentidos, mostrando o conteúdo completo e do
                        zero a otimização e lançamento!</p>
                    <div itemprop="reviewRating" itemscope itemtype="https://schema.org/Rating">
                        <p>Minha nota é <span itemprop="ratingValue">5</span> em 5</p>
                    </div>
...
<div class="container bg-orange">
    <div class="content content-page">
        <p class="fontsize1b font-light m-bottom al-center">Deixe seu nome e e-mail com seu interesse, e podemos te
            enviar uma oferta!</p>
    ...
    <div class="content">
        ...
        for ($i = 1; $i <= 3; $i++):
            ...
            <article itemscope itemtype="https://schema.org/Event" class="box box-medium bg-blue boxshadow<?= $last; ?> " style="font-size: 0.8em; padding: 25px;">
                ...
                <p>
                    <time itemprop="startDate" datetime="2014-10-20T08:20:00-03:00"><b>Abertura:</b> 20 de outubro de
                        2014 às 8:20hs
                    </time>
                    <br>
                    <time itemprop="endDate" datetime="2014-10-27T23:59:00-03:00"><b>Fechamento:</b> 27 de outubro de
                        2014 às 23:59hs
                    </time>
                </p>
                ...
                <div itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                    ...
                    <a itemprop="url" class="btn btn-green radius" title="Quero Participar" href="https://www.upinside.com.br/cesta/index/novo-item/curso-html5">Matrícula</a>
                </div>
            </article>
        <?php endfor; ?>
