<section class="container">
    <div class="content">
        ...
        <form action="" method="">
            <input type="search" list="s"  autofocus style="width: 80%; margin: 0 10%;" placeholder="Uma Pequisa Selecionada! Carregue a Página e Saia Digitando!">
        </form>
        <p class="al-center" style="color: #E16F4D; margin-top: 5px;">Todos os Efeitos e Eventos Desta Página Foram
            Criados Utilizando Exclusivamente HTML5 e CSS! </p>
    </div>
    <div class="clear"></div>
    ...
    <article class="container bg-light">
        ...
        <aside class="fl-right contact_info box-forthreesmall">
            <h1 class="form-legend">
                <span class="shorticon shorticon-mail shorticon-legendtitle">Formas de Contato:</span></h1>
            <ul>
                <li><b>Por Telefone:</b>+55 54 3381.2185</li>
                <li><b>Por
                        E-mail:</b><a title="Envie um email" href="mailto:cursos@upinside.com.br?subject=Fale Conosco">Cursos@upinside.combr</a>
                </li>
                <li><b>Por FaceBook:</b><a title="UpInside no Facebook" href="http://facebook.com.br">fb.com/alfa</a>
                </li>
            </ul>
            <p>
        ...
        <div class="content">
            ...
            <form action="" method="post">
                ...
                <div class="box box-full" style="margin-top: 20px;">
                    <p class="fl-right" style="margin-top: 20px; color: #fbfbfb">Lembre-se de estar utilizando um
                        browser atualizado. No Chrome tudo funciona!</p>
                    <input type="submit" class="btn btn-green radius" value="Enviar"/>
                </div>
            </form>
        ...
        <div class="container bg-light">
            <div class="content" style="background: url(<?= INCLUDE_PATH; ?>/img/mapa.png) center center no-repeat">
                <form action="" method="post">
                    ...
                    <div class="box box-full" style="margin-top: 20px;">
                        <p class="fl-right" style="margin-top: 20px; color: #555">Lembre-se de estar utilizando um
                            browser atualizado. No Chrome tudo funciona!</p>
                        <input type="submit" class="btn btn-green radius" value="Enviar"/>
                    </div>
                </form>
        ...
        <div class="content">
            ...
            <div class="fl-left" style="width: 80%; margin: 0 10%; padding: 30px; background: rgba(0,0,0,0.3);">
                <form action="" method="post">
                    ...
                    <label>
                        <span class="form-field">Informe Sua Senha Com 5 - 10 Caracteres</span>
                    ...
                    <label>
                        ...
                        <input type="email" pattern="^[^*]@[^*]+\.[a-z]{2,4}$" required title="Informe Um Email Valido">
                    </label>

                    <label>
                        <span class="form-field">O Cep da Sua Cidade:</span>
                        <input type="text" pattern="^([[0-9]{5})-([0-9]){3}$" required title="Informe o Cep">
                    </label>

                    <label>
                        <span class="form-field">Uma Data:</span>
                        <input type="text" pattern="^(0[1-9]|1[0-9]|2[0-9]3[0-1])/(0[1-9]|1[0-2])/([0-9]{4})$" required title="Informe uma Data">
                    </label>
