...
<article class="container">
    <div class="content">
        <header class="sectiontitle">
            ...
            <p class="tagline">Veja o que o tutor do curso
                <mark>Robson V. Leite</mark>
                tem a dizer!
            </p>
        </header>

        <video class="video video-large main_video" src="<?php HOME; ?>/uploads/midias/apresentacao.mp4" controls width="400"></video>

        <aside class="al-center">
            <h1>Pronto para
                <a class="btn btn-green radius" title="Comprar Curso WS HTML5 Agora!" target="_blank" href="http://www.upinside.com.br/curso/curso-html5">Comprar
...
<section class="container bg-orange">
    ...
    <div class="content">
        <header class=" sectiontitle sectiontitle-nomargin">
            ...
            <p class="tagline">O Curso WS HTML5 apresenta técnicas com foco em produção e otimização de conteúdo para
                internet!</p>
        </header>
        <div class="clear"></div>
    </div>
