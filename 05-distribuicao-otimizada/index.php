...
<head>
    ...
    <meta property="twitter:imge:src" content="<?= $pg_image ; ?>" />
    ...
    <link rel="stylesheet" href="themes/wshtml/css/boot.css"/>
...
<footer class="container bg-light">
    <section class="main_footer content">
        ...
        <nav class="box box-medium">
            ...
            <ul>
                <li>
                    <a class="shorticon shoticon-section" title="Assita o vídeo de apresentação com Robson V. Leite" href="#apresentacao">Assista
                        o Vídeo</a></li>
                <li>
                    <a class="shorticon shoticon-section" title="Veja as tecnologias que você vai aprender!" href="#tecnologias">Você
                        vai Aprender</a></li>
                <li>
                    <a class="shorticon shoticon-section" title="Mais informações na ficha técnica do curso!" href="#fichatecnica">Ficha
                        Técnica</a></li>
            </ul>
        </nav>
        ...
        <article class="box box-medium">
            ...
            <ul>
                <li>
                    <a class="shorticon shoticon-facebook" target="_blank" rel="nofollow" title="UpInside Treinamentos no Facebook" href="http://www.facebook.com/upinside">Facebook</a>
                </li>
                <li>
                    <a class="shorticon shoticon-google" target="_blank" rel="nofollow" title="UpInside Treinamentos no Google Plus" href="http://plus.google.com/+upinside">Google+</a>
                </li>
                <li>
                    <a class="shorticon shoticon-twitter" target="_blank" rel="nofollow" title="UpInside Treinamentos no Twitter" href="http://www.twitter.com/UpInsideBr">Twitter</a>
                </li>
            </ul>
        </article>
        ...
        <article class="main_ead box box-medium last">
            ...
            <p class="shorticon shoticon-config"><b>Plataforma EAD:</b>
                <a title="Plataforma EAD da UpInside" href="http://www.upisnide.com.br">www.upinside.com.br</a></p>
            <p class="shorticon shoticon-mail"><b>E-mail:</b>
